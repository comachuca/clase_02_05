...
<!-- no cacho esto --> 
 ...
 <p>Puedo consultar el narreglo con un ciclo for</p>
          <ul>
...
<!-- cierre del no cacho esto -->           

          <pre class="my-3"><code><?php print_r($arreglobjeto);?></code></pre>
          <hr>

<p> Mi nombre es <?php print ($arreglobjeto[nombres].' '.$arregloobjeto[apellidos])
                  ;?>,
          tengo <?php print ($arreglobjeto[edad]);?>,
    ...
    <script>
      ...
      // <?php     ?> es equivalente al <script></scrip t> (separé para que el código lo siga tomando como comentario)
    </script>
